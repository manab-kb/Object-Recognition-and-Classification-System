...
class Page2(Frame):
    def __init__(self, parent, controller):
        ...
        def test():
            global file_name, accuracy, indices
            nonlocal cnt
            cnt = 1
            '''
            ...
            image_classes = ['Beaver', 'Dolphin', 'Otter', 'Seal', 'Whale', 'Aquarium', 'Fish', 'Flatfish', 'Ray',
                             'Shark',
                             'Trout', 'Orchids', 'Poppies', 'Roses', 'Sunflowers', 'Tulips', 'Bottles', 'Bowls', 'Cans',
                             'Cups', 'Plates', 'Apples', 'Mushrooms', 'Oranges', 'Pears', 'Sweet Peppers', 'Clock',
                             'Computer Keyboard', 'Lamp',
                             ...
                             'House', 'Road',
                             'Skyscraper', 'Cloud', 'Forest', 'Mountain', 'Plain', 'Sea', 'Camel', 'Cattle',
                             'Chimpanzee', 'Elephant',
                             'Kangaroo', 'Fox', 'Porcupine', 'Possum', 'Racoon', 'Skunk', 'Crab', 'Lobster', 'Snail',
                             'Spider', 'Worm',
                             'Baby', 'Boy', 'Girl', 'Man', 'Woman', 'Crocodile', 'Dinosaur', 'Lizard', 'Snake',
                             'Turtle', 'Hamster',
                             'Mouse', 'Rabbit', 'Shrew', 'Squirrel', 'Maple', 'Oak', 'Palm', 'Pine', 'Pillow',
                             'Bicycle', 'Bus'
                                        'Motorcycle', 'Pickup Truck', 'Train', 'Lawn-Mower', 'Rocket', 'Streetcar',
                             'Tank', 'Tractor']

            for i in range(len(prds)):
                for j in range(i+1):
                    if prds[i][j] >= 0.8 or prds[i][j] <= 1:
                        indices = j

            res = image_classes[indices]
